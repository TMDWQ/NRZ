...
import com.men_cloths.util.BeingLoaded;
...
public class HomeActivity extends FragmentActivity{
    ...
    public static BeingLoaded loaded;
    ...
    protected void onRestart() {
        initial();
        if(mineLoginFragment!=null) {
            if(mineLoginFragment.getTextView()!=null)
            mineLoginFragment.getTextView().setText(UserInfo.getName(this));
        }
        super.onRestart();
    }
    ...
    public void onBackPressed() {
        if(exit){
           finish();
            ...
            Toast.makeText(this,"再次点击退出男人装",Toast.LENGTH_SHORT).show();
            exit=true;
            canBeExit();
        }
