 ...
 */
public abstract class CollocateAdapter extends BaseAdapter{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final Collocate collocate=collocateList.get(position);
        if(position%2==0) {
...
//            viewHolder.wholeImg1.setOnClickListener(new View.OnClickListener() {
//                @Override
//                public void onClick(View v) {
//                    click(collocate.getWholeImg());
//                }
//            });
...
//            viewHolder.wholeImg2.setOnClickListener(new View.OnClickListener() {
//                @Override
//                public void onClick(View v) {
//                    click(collocate.getWholeImg());
//                }
//            });
        ...
        viewHolder.partImg1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                click(collocate.getPartImg1());
                ShopInfomation.save(collocate.getPartImg1Title(),"黑色","XLL","￥"+231+"","",context);
            }
        });

        viewHolder.partImg2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                click(collocate.getPartImg2());
                ShopInfomation.save(collocate.getPartImg2Title(),"黑色","XLL","￥"+231+"","",context);

            }
        });

        viewHolder.partImg3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                click(collocate.getPartImg3());
                ShopInfomation.save(collocate.getPartImg3Title(),"黑色","XLL","￥"+231+"","",context);
            }
        });

        viewHolder.partImg4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                click(collocate.getPartImg4());
                ShopInfomation.save(collocate.getPartImg4Title(),"黑色","XLL","￥"+231+"","",context);
            }
        });
    ...
    public abstract void click(String url);
