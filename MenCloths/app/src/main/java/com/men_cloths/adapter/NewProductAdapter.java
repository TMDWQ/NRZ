 ...
 */
public abstract class NewProductAdapter extends BaseAdapter{
    Context context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final NewProduct newProduct=newProductList.get(position);
        ...
        viewHolder.img1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                click1(newProduct.getImg1());
                ShopInfomation.save(newProduct.getContent1(),"黑色","XLL","￥"+newProduct.getPrice1()+"","",context);
            }
        });
        viewHolder.img2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                click2(newProduct.getImg2());
                ShopInfomation.save(newProduct.getContent2(),"黑色","XLL","￥"+newProduct.getPrice2()+"","",context);
            }
        });
        return convertView;
    }
