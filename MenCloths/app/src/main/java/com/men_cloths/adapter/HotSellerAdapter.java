 ...
 */
public abstract class HotSellerAdapter extends BaseAdapter{
    Context context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final HotSeller hotSeller=hotSellerList.get(position);
        ...
        viewHolder.hotImg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                click(hotSeller.getHotImg());
                ShopInfomation.save(hotSeller.getHotContent(),"黑色","XLL","￥"+hotSeller.getHotPrice()+"","",context);
            }
        });
        return convertView;
    }
